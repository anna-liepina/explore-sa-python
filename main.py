...
#         # def area_search(entity, pattern=None, limit=None, page=None):
#         # query = orm.Area.select()

#         # if postcodePattern:
#         #     query = (query
#         #             .where(Area.area.contains(postcodePattern))
#         #             .or_where(Area.city.contains(postcodePattern)))

#         # if perPage and page:
#         #     offset = (page - 1) * perPage
#         #     query = query.perPage(perPage).offset(offset)
